                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="admin-form-control" id="icon_fa" name="icon_fa"
                                       placeholder="fa-solid fa-server" value="<?php echo htmlspecialchars($icon_fa, ENT_QUOTES, 'UTF-8'); ?>" oninput="atualizarPreviewIcone()">
                            </div>
                            <div class="col-md-4">
                                <label class="small fw-semibold">Upload de Imagem (PNG/JPG/WEBP)</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="url" class="admin-form-control" id="icon_url" name="icon_url"
                                       placeholder="https://..." value="<?php echo htmlspecialchars($icon_url, ENT_QUOTES, 'UTF-8'); ?>" oninput="atualizarPreviewIcone()">
                            </div>
                        </div>
                        <div class="mt-3 d-flex align-items-center gap-2">
                            <span class="small text-muted">Preview do Ícone:</span>
...
function atualizarPreviewIcone() {
    ...
    if (fa) {
        ...
        box.innerHTML = `<i class="fa-solid fa-server text-muted"></i>`;
    }
}
