                ...
                <form method="POST" action="editar.php?id=<?php echo (int)$id; ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 p-3 bg-light rounded border">
                        ...
                        <div class="form-text small mb-2">
                            Envie um novo arquivo para substituir a foto atual. O sistema converte automaticamente para <strong>.webp</strong> em <code>/assets/parceiros/</code>.
                        </div>

                        <div class="row g-3 align-items-center">
                            <div class="col-12 col-sm-auto text-center">
                                <img id="preview-foto" src="<?php echo htmlspecialchars($foto ?: '/assets/images/logo.webp', ENT_QUOTES, 'UTF-8'); ?>" alt="Prévia" class="rounded-circle border shadow-sm" style="width: 80px; height: 80px; object-fit: cover;" onerror="this.src='/assets/images/logo.webp'">
                            </div>
                            <div class="col">
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <label for="foto_url" class="form-label small fw-semibold mb-1">Ou informe uma URL / Caminho</label>
