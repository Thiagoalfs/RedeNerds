window.NOVIDADES = [
    ...
    {
        id: "2",
        title: "Atualização do modpack #1",
        description: "A primeira atualização do modpack já chegou!\n\n Essa versão foca em correções de desempenho e alguns ajustes de balanceamento que a galera pediu desde o lançamento.\n\nEntre as mudanças principais estão a remoção de mods conflitantes, otimização de configs e a adição de dois novos mods de qualidade de vida.\n\n../assets/images/fundo.png\n\nAtualize pelo launcher antes de entrar no servidor. Jogadores com a versão antiga não conseguirão conectar.",
        date: "22/06/2026",
        image: "../assets/images/fundo.png",
        category: "NerdDead",
        author: "xPernaLongax"
